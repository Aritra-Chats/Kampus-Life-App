...
object RetrofitClient {
    ...
    private val client = OkHttpClient.Builder().addInterceptor(logger).connectTimeout(50, TimeUnit.SECONDS).readTimeout(50, TimeUnit.SECONDS).writeTimeout(50, TimeUnit.SECONDS)
